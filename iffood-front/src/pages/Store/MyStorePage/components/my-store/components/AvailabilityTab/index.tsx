...
import { useUpdateStoreAvailabilities } from "@/pages/Store/MyStorePage/hooks/use-store-mutations";
import { useStoreAvailabilities } from "@/pages/Store/MyStorePage/hooks/use-store-queries";
